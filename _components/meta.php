...
<title><?php echo isset($pageTitle) ? $pageTitle . ' - ' . $common['appName'] : $common['appTitle']; ?></title>
<meta name="description" content="<?php echo isset($pageDescription) ? $pageDescription : $common['appDescription']; ?>">

<!-- SEO Meta Tags -->
<meta name="keywords" content="bitcoin education, learn bitcoin, bitcoin app, <?php echo strtolower($common['appName']); ?>, bitcoin quests, bitcoin for beginners">
...
<meta property="og:title" content="<?php echo isset($pageTitle) ? $pageTitle . ' - ' . $common['appName'] : $common['appTitle']; ?>">
...
<meta name="twitter:image" content="https://odysseybtc.app/assets/odyssey_twitter_card.png">
